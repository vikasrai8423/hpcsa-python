...
print(my_dict)   
# my_dict.update({ "city" : "OverWritten", "state":"MH","gender" : "male"})
my_dict|= { "city" : "OverWritten", "state":"MH","gender" : "male"}
print(my_dict)   
...
# #****************               
# #Update and |= seem to be doing the same thing


# my_dict = {1: "One" , 2: "Two"}
# print(my_dict)   
# my_dict.update({ 1 : "Updated One",3: "Three"})
# print(my_dict)   

# print("|= operator use starts ")
# my_dict = {1: "One" , 2: "Two"}
# print(my_dict)
# my_dict|= { 1 : "Updated One",3: "Three"}
# print(my_dict)